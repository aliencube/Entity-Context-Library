...
namespace Aliencube.EntityContextLibrary.Extensions
{
    ...
    public static partial class DbContextQueryExtensions
    {
        ...
        public static IEnumerable<TOutput> ExecuteStoreQuery<TOutput>(this DbContext context, string commandText, IDictionary<string, object> input)
        {
        ...
        /// <param name="input">List of input values.</param>
        /// <returns>Returns the list of <c>TOutput</c> objects.</returns>
        public static IEnumerable<TOutput> ExecuteStoreQuery<TOutput>(this DbContext context, string commandText, ExecutionOptions executionOptions, IDictionary<string, object> input)
        {
            var parameters = ConvertHelper.ConvertToParameters(input);
            var adapter = (IObjectContextAdapter)context;
        ...
        /// <param name="input">List of input values.</param>
        /// <returns>Returns the list of <c>TOutput</c> objects.</returns>
        public static IEnumerable<TOutput> ExecuteStoreQuery<TOutput>(this DbContext context, string commandText, string entitySetName, ExecutionOptions executionOptions, IDictionary<string, object> input)
        {
            var parameters = ConvertHelper.ConvertToParameters(input);
            var adapter = (IObjectContextAdapter)context;
        ...
        /// <param name="input">List of input values.</param>
        /// <returns>Returns the list of <c>TOutput</c> objects.</returns>
        public static IEnumerable<TOutput> ExecuteStoreQuery<TOutput>(this DbContext context, string commandText, string entitySetName, MergeOption mergeOption, IDictionary<string, object> input)
        {
            var parameters = ConvertHelper.ConvertToParameters(input);
            var adapter = (IObjectContextAdapter)context;
        ...
        /// <param name="input">List of input values.</param>
        /// <returns>Returns the list of <c>TOutput</c> objects.</returns>
        public static async Task<IEnumerable<TOutput>> ExecuteStoreQueryAsync<TOutput>(this DbContext context, string commandText, IDictionary<string, object> input)
        {
            var parameters = ConvertHelper.ConvertToParameters(input);
            var adapter = (IObjectContextAdapter)context;
        ...
        /// <param name="input">List of input values.</param>
        /// <returns>Returns the list of <c>TOutput</c> objects.</returns>
        public static async Task<IEnumerable<TOutput>> ExecuteStoreQueryAsync<TOutput>(this DbContext context, string commandText, ExecutionOptions executionOptions, IDictionary<string, object> input)
        {
            var parameters = ConvertHelper.ConvertToParameters(input);
            var adapter = (IObjectContextAdapter)context;
        ...
        /// <param name="input">List of input values.</param>
        /// <returns>Returns the list of <c>TOutput</c> objects.</returns>
        public static async Task<IEnumerable<TOutput>> ExecuteStoreQueryAsync<TOutput>(this DbContext context, string commandText, CancellationToken cancellationToken, IDictionary<string, object> input)
        {
            var parameters = ConvertHelper.ConvertToParameters(input);
            var adapter = (IObjectContextAdapter)context;
        ...
        /// <param name="input">List of input values.</param>
        /// <returns>Returns the list of <c>TOutput</c> objects.</returns>
        public static async Task<IEnumerable<TOutput>> ExecuteStoreQueryAsync<TOutput>(this DbContext context, string commandText, ExecutionOptions executionOptions, CancellationToken cancellationToken, IDictionary<string, object> input)
        {
            var parameters = ConvertHelper.ConvertToParameters(input);
            var adapter = (IObjectContextAdapter)context;
        ...
        /// <param name="input">List of input values.</param>
        /// <returns>Returns the list of <c>TOutput</c> objects.</returns>
        public static async Task<IEnumerable<TOutput>> ExecuteStoreQueryAsync<TOutput>(this DbContext context, string commandText, string entitySetName, ExecutionOptions executionOptions, IDictionary<string, object> input)
        {
            var parameters = ConvertHelper.ConvertToParameters(input);
            var adapter = (IObjectContextAdapter)context;
        ...
        /// <param name="input">List of input values.</param>
        /// <returns>Returns the list of <c>TOutput</c> objects.</returns>
        public static async Task<IEnumerable<TOutput>> ExecuteStoreQueryAsync<TOutput>(this DbContext context, string commandText, string entitySetName, ExecutionOptions executionOptions, CancellationToken cancellationToken, IDictionary<string, object> input)
        {
            var parameters = ConvertHelper.ConvertToParameters(input);
            var adapter = (IObjectContextAdapter)context;
