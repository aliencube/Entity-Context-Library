...
::BUILD
"tools\nuget.exe" restore EntityContextLibrary.sln
"%MSBUILDDIR%msbuild.exe" "03_Services\EntityContextLibrary\EntityContextLibrary.csproj" /t:ReBuild /p:Configuration=Release;TargetFrameworkVersion=v4.5;DefineConstants="TRACE;NET45";OutPutPath=bin\Release\net45\;DocumentationFile=bin\Release\net45\Aliencube.EntityContextLibrary.xml
...
::PACK
"tools\nuget.exe" pack "03_Services\EntityContextLibrary\EntityContextLibrary.nuspec" -OutputDirectory build
